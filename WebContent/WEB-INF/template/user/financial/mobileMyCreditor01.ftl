...
<div class="myCreditor" id="myCreditor_tab1">
	<table class="table table-hover" style="margin: -4px -4px;">
		<thead>
			<tr>
				<th style="width:0.1%;text-align: left;">借款标题</th>
				<!--<th>标的总额</th> -->
				<!--<th>投资金额</th> -->
				<!-- <th style="width:8%;text-align: center;">年利率</th>
				<th style="width:18%;text-align: center;">剩余债权</th> -->
				<th style="width:0.1%;text-align: left;">收益金额</th>
				<!-- <th style="width:12%;text-align: center;">剩余期数/期数</th> -->
				<!--<th>状态</th>-->
				<th style="width:0.5%;text-align: left;">收款日期</th>
		...
		$.ajax({
				...
				success:function(data) {
			        ...
			        $.each(data.list, function(i, n){
			        	...
			        	row.append($("<td style=\"width:5px;text-align: left;\" ><a target='_blank' href=\"${base}/loan/detail.do?loanApproveId="+n.loan_approve_id +"\" title=\""+n.loanName+"\">"+n.loan_name+"</a></td>"));
			        	...
			        	row.append($("<td style=\"width:5px;text-align: left;\" >" + fmoney(n.tot_profit_amt,2) + "</td>"));
			        	/* row.append($("<td style=\"width:5%;text-align: center;\" >" + n.surplus_period + "/"+n.total_period+"</td>")); */
			        	//row.append($("<td>" + n.cr_status_cd + "</td>"));
			        	row.append($("<td style=\"width:5px;text-align: left;\" >" + n.next_gather_date + "</td>"));
