	...
	<div class="con" style="border:0px;">
        ...
        <div class="right_con" style="width:820px;float:right;margin-top:10px;height:auto">
        	<div class="text">
	        	...
	        	<h3>&nbsp;<font size="4">内蒙古网点</font></h3>
	        	</div>
	        	<h2 class="about-title">&nbsp;&nbsp;<font size="3">呼伦贝尔镒华投资管理有限公司</font></h2>
	        	<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;代理区域：呼伦贝尔市</p>
	            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;联系地址：呼伦贝尔市海拉尔区正阳办畅通综合楼3号楼012号 </p> 
				<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;联系电话：0470-3912999 </p>
				<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;联系人：谢先生</p> 
				<h2 class="about-title">&nbsp;<font size="3">证照公示</font></h2>
				<div style="padding:0px;"><img src="${base}/platform/img/aboutusWeb1_1.png" align="center" hspace="12" /></div>
				<div style="padding:0px;"><img src="${base}/platform/img/aboutusWeb1_2.png" align="center" hspace="12" /></div>
				<div style="padding:0px;"><img src="${base}/platform/img/aboutusWeb1_3.png" align="center" hspace="12" /></div>
				<div style="padding:0px;"><img src="${base}/platform/img/aboutusWeb1_4.png" align="center" hspace="12" /></div>
	            <p>&nbsp;</p>
