	...
	<div class="con" style="border:0px;">
        ...
        <div class="right_con" style="width:820px;float:right;margin-top:10px;height:auto">
        	<div class="text">
	        	...
	        	<h3>&nbsp;<font size="4">深圳网点</font></h3>
	        	</div>
	        	<h2 class="about-title">&nbsp;&nbsp;<font size="3">深圳市深聚镒投资管理有限公司</font></h2>
	        	<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;代理区域：深圳市</p>
	            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;联系地址：深圳市龙岗区龙城街道中心城龙城大道99号正中时代广场1307单位  </p> 
				<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;联系电话：0755-84560567  </p>
				<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;联系人：林先生</p> 
				<h2 class="about-title">&nbsp;<font size="3">证照公示</font></h2>
				<div style="padding:0px;"><img src="${base}/platform/img/aboutusWeb2_1.png" align="center" hspace="12" /></div>
				<div style="padding:0px;"><img src="${base}/platform/img/aboutusWeb2_2.png" align="center" hspace="12" /></div>
				<div style="padding:0px;"><img src="${base}/platform/img/aboutusWeb2_3.png" align="center" hspace="12" /></div>
				<div style="padding:0px;"><img src="${base}/platform/img/aboutusWeb2_4.png" align="center" hspace="12" /></div>
	            <p>&nbsp;</p>
