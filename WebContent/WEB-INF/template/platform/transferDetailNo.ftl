		...
		<div class="new-info-page">
			...
			<div class="bond-info-box-two">
				...
				<#--<div class="float3">
					...
					<div class="con-two" >
						<span class="sp-one" >可用金额</span><span class="sp-mon"><#if custAccountVO.avaiBal?? >${custAccountVO.avaiBal}<#else></#if></span><span class="sp-two" ><a href="${base}/userFund/myRecharge.do" style="color:blue">充值</a></span>
					</div>
				...
				<div class="repayfloat3">
					<div class="repay-con" >
						<#if loanRepayInfoVo.sumRepayAmt??>
						    <span class="sp-one">待还本息</span><span class="sp-two"><em>￥${loanRepayInfoVo.sumRepayAmt}</em></span>
						<#else>
						    <span class="sp-one">待还本息</span><span class="sp-two"><em>0</em></span>
						</#if>
					</div>
					<div class="repay-con" >
						<#if loanRepayInfoVo.restPeriods??>
						    <span class="sp-one" >剩余期数</span><span class="sp-two">${loanRepayInfoVo.restPeriods}（月）</span>
						<#else>
						    <span class="sp-one" >剩余期数</span><span class="sp-two">0（月）</span>
						</#if>
				...
				<div class="clear"></div>    <#--￥<em style="color:#f60;">${custAccountVO.avaiBal?string(',##0.00')}</em>-->
			</div>
        </div>
