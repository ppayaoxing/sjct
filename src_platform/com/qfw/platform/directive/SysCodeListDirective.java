 ...
 * 
 */
public class SysCodeListDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		if (null != sysCodeDictList && !sysCodeDictList.isEmpty()) {
			for (SysCodeDict sysCodeDict : sysCodeDictList) {
				env.getOut()
						.write("<span value=\"" + sysCodeDict.getCodeValue()
								+ "\"><a href=\"javascript:void(0);\">" + sysCodeDict.getDisplayValue() + "</a></span>");
			}
		}
	}
}