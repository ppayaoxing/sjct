...
public interface IAgentIncomeDAO {
	...
	public List<AgentIncomeDetailVO> findLeaderDetail(AgentIncomeVO vo,int first, int pageSize);

	public List<AgentIncomeDetailVO> findAgentDetailByLeaderId(AgentIncomeVO vo ,int first, int pageSize);

	public List<AgentIncomeDetailVO> findAgentDetail(AgentIncomeVO vo,int first, int pageSize);
