 ...
 */
@ViewScoped
@ManagedBean(name="rechargeCardBean")
public class RechargeCardBackingBean extends BaseBackingBean{
	...
	private RechargeCardResponseVO cardVO = new RechargeCardResponseVO();
