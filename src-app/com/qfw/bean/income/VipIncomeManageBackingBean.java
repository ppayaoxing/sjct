 ...
 */
@ViewScoped
@ManagedBean(name="vipIncomeBean")
public class VipIncomeManageBackingBean extends BaseBackingBean{
	...
	public void init() {
		if(tradeVO != null){ 
			try {
				...
				tradeVO.setTradeTypeCd(AppConst.TRADE_TYPE_VIP_INCOME);
	...
	public void sum(){
		BigDecimal sum = tradeBS.sumByVO(tradeVO);
		alertInfo("总收益"+sum.toString());
	}
