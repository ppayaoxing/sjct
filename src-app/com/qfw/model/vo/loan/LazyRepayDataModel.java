...
public class LazyRepayDataModel extends LazyDataModel<LoanManageVO> {
	...
	public LazyRepayDataModel(LoanSearchVO searchVO, ILoanManageBS loanManageBS){
