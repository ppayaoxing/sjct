 ...
 *
 */
public abstract class BatchCycleJob implements IBatchJob {

	private Logger logger = Logger.getLogger(BatchCycleJob.class);
	...
	public void run() {
		...
		try {
			...
			if(isCanBeRun()){
				...
				completeJob(String.valueOf(JobStatus.SUCCESS_CYCLE), runStr);
