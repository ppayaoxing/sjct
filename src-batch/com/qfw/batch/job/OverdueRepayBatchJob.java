 ...
 *
 */
public class OverdueRepayBatchJob extends BatchDependJob {
	...
	public String runJob() throws Exception {
		...
		//System.out.println("自动逾期还款批处理开始执行,当前日期为:"+batchDate);
		IBatchBS batchBS = (IBatchBS)ApplicationContextUtil.getBean("batchBS");
		batchBS.autoRepayOverdueForFull(batchDate);
		//System.out.println("自动逾期还款批处理结束执行");
