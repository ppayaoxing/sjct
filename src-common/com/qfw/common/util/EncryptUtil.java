 ...
 * @return
 */
public final static String encoderByDES(String plainText, String key) {
    try {
 ...
 * @return
 */
public final static String decoderByDES(String secretText, String key) {
    try {
...
public static  byte[] coderByDES(byte[] plainText, String key, int mode)
 ...
 public static void main(String[] args) {
	 String password = EncryptUtil.encoderByDES("123456", "535");
	 //System.out.println("加密后："+password);
	 //System.out.println("加密后："+EncryptUtil.decoderByDES(password, "535"));
}
