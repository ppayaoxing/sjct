...
public class StringUtils {
	...
	public static String arr2string(int[] obj) {
		...
		if (obj instanceof int[]) {
			...
			ret = StringUtils.isEmpty(sb.toString()) ? "" : sb.toString()
	...
	public static void main(String[] args) {
		//System.out.println(getBASE64(" 发啊飞"));
		//System.out.println(UUID.randomUUID());
		// //System.out.println(StringUtils.newLineOutput("你好很好 方法 发啊飞但是", 2));
	}
	 ...
	 * @return
	 */
	public static String getTemplateStr(String templateStr,Map<String, String> dataMap){
		try {
			if(isEmpty(templateStr)){
				return templateStr;
			}
			StringReader reader = new StringReader(templateStr);
			Template template = new Template("strTemplate", reader,new Configuration());
