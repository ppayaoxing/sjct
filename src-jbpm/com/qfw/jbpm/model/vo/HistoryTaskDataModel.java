...
public class HistoryTaskDataModel extends LazyDataModel<TaskVO> {
	
	private FilterTaskVO filterVO;
	
	private List<TaskVO> tasks;
	
	public HistoryTaskDataModel(FilterTaskVO filterVO){
	...
	public List<TaskVO> load(int first, int pageSize, String sortField,
		...
		PageList<TaskVO> pl = flowBS.findMyHistoryTask(filterVO, first, pageSize);
		tasks = pl.getData();
